...
TCHAR szCommandControl[10];
TCHAR szSvcNameControl[80];

SC_HANDLE schSCManager;
SC_HANDLE schService;

VOID __stdcall DisplayUsageControl(void);
...
void _tmain(int argc, TCHAR* argv[])
{
    ...
    StringCchCopy(szCommandControl, 10, argv[1]);
    StringCchCopy(szSvcNameControl, 80, argv[2]);

    if (lstrcmpi(szCommandControl, TEXT("start")) == 0)
        DoStartSvc();
    else if (lstrcmpi(szCommandControl, TEXT("dacl")) == 0)
        DoUpdateSvcDacl();
    else if (lstrcmpi(szCommandControl, TEXT("stop")) == 0)
        DoStopSvc();
    else
    {
...
VOID __stdcall DisplayUsageControl()
{
    printf("Description:\n");
...
VOID __stdcall DoStartSvc()
{
    ...
    schService = OpenService(
        ...
        szSvcNameControl,            // name of service 
